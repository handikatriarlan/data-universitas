                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Daftar Pengabdian Masyarakat</h5>
                                    </div>
                                    <div class="card-block">
                                        <div class="dt-responsive table-responsive">
                                            <table style="text-align: center" id="order-table"
                                                ...
                                                <tbody>
                                                    <?php $index = 1; ?>
                                                    @foreach ($pengabdianMasyarakats as $pengabdianMasyarakat)
                                                        <tr>
                                                            <td>{{ $index++ }}</td>
                                                            <td>{{ $pengabdianMasyarakat->tgl_transaksi }}</td>
                                                            <td>{{ $pengabdianMasyarakat->jumlah }}</td>
                                                            <td>
                                                                <i class="ti-pencil text-success edit"
                                                                    style="font-size: 18px"
                                                                    data-id={{ $pengabdianMasyarakat->id }}></i>
...
@section('own_js')
    ...
    <script type="text/javascript" src="{{ asset('own_assets/scripts/pages/pengabdian-masyarakat.js') }}"></script>
@endsection
