                                    ...
                                    <div class="card-block">
                                        <div class="dt-responsive table-responsive">
                                            <table style="text-align: center" id="order-table"
                                                ...
                                                <tbody>
                                                    <?php $index = 1; ?>
                                                    @foreach ($publikasiPenelitians as $publikasiPenelitian)
                                                        <tr>
                                                            <td>{{ $index++ }}</td>
                                                            <td>{{ $publikasiPenelitian->tgl_transaksi }}</td>
                                                            <td>{{ $publikasiPenelitian->unit }}</td>
                                                            <td>{{ $publikasiPenelitian->nasional }}</td>
                                                            <td>{{ $publikasiPenelitian->internasional }}</td>
                                                            <td>{{ $publikasiPenelitian->internasional_index }}</td>
                                                            <td>{{ $publikasiPenelitian->prosiding }}</td>
                                                            <td>{{ $publikasiPenelitian->seminar }}</td>
                                                            <td>{{ $publikasiPenelitian->kategori }}</td>
                                                            <td>
                                                                <i class="ti-pencil text-success edit"
                                                                    style="font-size: 18px"
                                                                    data-id={{ $publikasiPenelitian->id }}></i>
                        ...
                        <div class="card-block">
                            <form id="main" novalidate>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" class="form-control" name="nasional" id="nasional"
                                            placeholder="Masukkan Nasional">
                                        <span class="messages"></span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" class="form-control" name="internasional"
                                            id="internasional" placeholder="Masukkan Internasional">
                                        <span class="messages"></span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" class="form-control" name="internasional_index"
                                            id="internasional_index" placeholder="Masukkan Internasional_index">
                                        <span class="messages"></span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" class="form-control" name="prosiding" id="prosiding"
                                            placeholder="Masukkan Prosiding">
                                        <span class="messages"></span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" class="form-control" name="seminar" id="seminar"
                                            placeholder="Masukkan Seminar">
                                        <span class="messages"></span>
                                    </div>
                                </div>
                                <div class="form-group row">
                            ...
                            <form id="main" novalidate>
                                ...
                                <form id="main" novalidate>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label">Nasional</label>
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control" name="edit_nasional"
                                                id="edit_nasional" placeholder="Masukkan Nasional">
                                            <span class="messages"></span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label">Internasional</label>
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control" name="edit_internasional"
                                                id="edit_internasional" placeholder="Masukkan Internasional">
                                            <span class="messages"></span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label">Internasional Index</label>
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control" name="edit_internasional_index"
                                                id="edit_internasional_index" placeholder="Masukkan Internasional_index">
                                            <span class="messages"></span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label">Prosiding</label>
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control" name="edit_prosiding"
                                                id="edit_prosiding" placeholder="Masukkan Prosiding">
                                            <span class="messages"></span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label">Seminar</label>
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control" name="edit_seminar"
                                                id="edit_seminar" placeholder="Masukkan Seminar">
                                            <span class="messages"></span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
...
@section('own_js')
    ...
    <script type="text/javascript" src="{{ asset('own_assets/scripts/pages/publikasi-penelitian.js') }}"></script>
@endsection
