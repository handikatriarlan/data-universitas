                                    ...
                                    <div class="card-block">
                                        <div class="dt-responsive table-responsive">
                                            <table style="text-align: center" id="order-table"
                                                ...
                                                <tbody>
                                                    <?php $index = 1; ?>
                                                    @foreach ($jumlahMahasiswas as $jumlahMahasiswa)
                                                        <tr>
                                                            <td>{{ $index++ }}</td>
                                                            <td>{{ $jumlahMahasiswa->tgl_transaksi }}</td>
                                                            <td>{{ $jumlahMahasiswa->fakultas }}</td>
                                                            <td>{{ $jumlahMahasiswa->jurusan }}</td>
                                                            <td>{{ $jumlahMahasiswa->prodi }}</td>
                                                            <td>{{ $jumlahMahasiswa->kategori }}</td>
                                                            <td>{{ $jumlahMahasiswa->jumlah }}</td>
                                                            <td>
                                                                <i class="ti-pencil text-success edit"
                                                                    style="font-size: 18px"
                                                                    data-id={{ $jumlahMahasiswa->id }}></i>
...
@section('own_js')
    ...
    <script type="text/javascript" src="{{ asset('own_assets/scripts/pages/jumlah-mahasiswa.js') }}"></script>
@endsection
